...
#-------------------------------------------------------------------------------
source $cape_dir/APB_BUS_CONVERTER.tcl
source $cape_dir/CoreAPB3_CAPE.tcl
source $cape_dir/CoreGPIO_LCD.tcl
# source $cape_dir/P8_GPIO_LCD.tcl
source $cape_dir/P8_GPIO_UPPER.tcl
source $cape_dir/CoreGPIO_P9.tcl
source $cape_dir/P9_GPIO.tcl
source $cape_dir/CAPE_DEFAULT_GPIOS.tcl
source $cape_dir/corepwm_C1.tcl
source $cape_dir/CAPE_PWM.tcl
source $cape_dir/CAPE.tcl
